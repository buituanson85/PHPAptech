    ...
    if(!isset($_SESSION['is_login'])){
        if(isset($_REQUEST['rEmail'])){
            ...
            if($result->num_rows == 1){
                ...
                $msg = '<div class="alert alert-warning mt-2" role="alert"> Nhập Email và Mật khẩu không Hợp lệ </div>';
            }
        }
    } else {
        echo "<script> location.href='RequesterProfile.php'; </script>";
...
<p class="text-center" style="font-size: 20px;">
    ...
    <span>Người yêu cầu Khu vực (Demo)</span>
</p>
<div class="container-fluid mb-5">
    <div class="row justify-content-center custom-margin">
        <div class="col-sm-6 col-md-4">
            ...
            <div class="text-center"><a class="btn btn-info mt-3 shadow-sm font-weight-bold" href="../index.php">Về Trang chủ</a></div>
        </div>
    </div>
</div>
