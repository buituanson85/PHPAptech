    ...
    if(isset($_REQUEST['assign'])){
        ...
        if(($_REQUEST['request_id'] == "") || ($_REQUEST['request_info'] == "") || ($_REQUEST['requestdesc'] == "") || ($_REQUEST['requestername'] == "") || ($_REQUEST['address1'] == "") || ($_REQUEST['address2'] == "") || ($_REQUEST['requestercity'] == "") || ($_REQUEST['requesterstate'] == "") || ($_REQUEST['requesterzip'] == "") || ($_REQUEST['requesteremail'] == "") || ($_REQUEST['requestermobile'] == "") || ($_REQUEST['assigntech'] == "") || ($_REQUEST['inputdate'] == "")){
            ...
            if($conn->query($sql) == TRUE){
                ...
                $msg = '<div class="alert alert-success col-sm-6 ml-5 mt-2" role="alert"> Công việc được giao thành công </div>';
            } else {
                // below msg display on form submit failed
                $msg = '<div class="alert alert-danger col-sm-6 ml-5 mt-2" role="alert"> Không thể chỉ định công việc </div>';
            }
        }
    }
...
<div class="col-sm-5 mt-5 jumbotron">
    ...
    <form action="" method="POST">
        <h5 class="text-center">Chỉ định Yêu cầu Đơn hàng Công việc</h5>
        ...
        <div class="form-group">
            <label for="request_info">Thông tin yêu cầu</label>
        ...
        <div class="form-group">
            <label for="requestdesc">Mô tả</label>
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-4">
                <label for="requesterstate">Thành phố</label>
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-4">
                <label for="requestermobile">Số điện thoại</label>
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                <label for="assigntech">Giao cho Kỹ thuật viên</label>
        ...
        <div class="float-right">
            <button type="submit" class="btn btn-success" name="assign">Chỉ định</button>
