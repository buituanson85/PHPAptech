...
<div class="col-sm-6 mt-5  mx-3 jumbotron">
  <h3 class="text-center">Cập nhật chi tiết người yêu cầu</h3>
  <?php
 ...
 ?>
  <form action="" method="POST">
    <div class="form-group">
      <label for="r_login_id">ID yêu cầu</label>
    ...
    <div class="text-center">
      <button type="submit" class="btn btn-danger" id="requpdate" name="requpdate">Cập nhật</button>
