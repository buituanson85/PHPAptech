...
<div class="col-sm-6 mt-5  mx-3 jumbotron">
  <h3 class="text-center">Cập nhật thông tin chi tiết về kỹ thuật viên</h3>
  <?php
 ...
 ?>
  <form action="" method="POST">
    <div class="form-group">
      <label for="empId">ID kỹ thuật</label>
    ...
    <div class="text-center">
      <button type="submit" class="btn btn-danger" id="empupdate" name="empupdate">Cập nhật</button>
