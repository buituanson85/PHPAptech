         ...
         if(($_REQUEST['r_name'] == "") || ($_REQUEST['r_email'] == "") || ($_REQUEST['r_password'] == "")){
          ...
          $msg = '<div class="alert alert-warning col-sm-6 ml-5 mt-2" role="alert"> Fill All Fileds </div>';
           ...
           if($conn->query($sql) == TRUE){
            ...
            $msg = '<div class="alert alert-success col-sm-6 ml-5 mt-2" role="alert"> Thêm mới thành công </div>';
           } else {
            // below msg display on form submit failed
            $msg = '<div class="alert alert-danger col-sm-6 ml-5 mt-2" role="alert"> Thêm mới không thành công </div>';
           }
         }
     }
?>
<div class="col-sm-6 mt-5  mx-3 jumbotron">
  <h3 class="text-center">Thêm người yêu cầu mới</h3>
  <form action="" method="POST">
    ...
    <div class="text-center">
      <button type="submit" class="btn btn-danger" id="reqsubmit" name="reqsubmit">Gửi</button>
      <a href="requester.php" class="btn btn-secondary">Đóng</a>
    </div>
