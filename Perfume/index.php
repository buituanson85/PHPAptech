        ...
        <div class="offcanvas_menu_wrapper">
            ...
            <div class="header_account">
                <ul>
                    <li class="language">
                        <a href="#">
                            <img src="images/icon/language.png" alt="En"> EN <i class="fa fa-angle-down"></i>
                        </a>
                    ...
                    <li class="mini_cart_wrapper">
                        ...
                        <div class="mini_cart mini_cart2">
                            <div class="cart_gallery">
                                <div class="cart_item">
                                    <div class="cart_img">
                                        <a href="#"><img src="images/small-product/mini1.png" alt="fe"></a>
                                    </div>
                                    <div class="cart_info">
                                        <a href="#">Hugo Boss</a>
                                ...
                                <div class="cart_item">
                                    <div class="cart_img">
                                        <a href="#"><img src="images/small-product/mini2.png" alt="fe"></a>
                                    </div>
                                    <div class="cart_info">
                                        <a href="#">Bvlgari</a>
            ...
            <div class="offcanvas_footer">
                <span><a href="#"><i class="fa fa-envelope-0"></i>son@gmail.com</a></span>
                <ul>
                    <li class="facebook"><a href="#"><i class="fa fa-facebook"></i></a></li>
                    <li class="twitch"><a href="#"><i class="fa fa-twitch"></i></a></li>
                                ...
                                <div class="header_right_info">
                                    <ul>
                                        <li class="search_box">
                                            ...
                                            <div class="search_widget">
                                                <form action="">
                                                    <input type="text" placeholder="Search your perfuma">
                                                    <button type="submit"><i class="fa fa-search"></i></button>
                                                </form>
                                            </div>
                                        </li>
                    ...
                    <div class="row">
                        <div class="col-lg-6 offset-lg-6 col-md-6 offset-md-6">
                            <div class="slider_content slider_content2 content_right">
                                ...
                                <h2>Wild Stone</h2>
                                <p>
                                    The rich aromatic notes of rosemary and nerolu combined with the sophistication
                                    of tonka beans and white beans and white woods to create the perfect accompaniment
                                    for the suited look.
                                </p>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-7">
                            <div class="slider_content slider_content2 content_left">
                                ...
                                <p>
                                    This perfume is a wonderful elixir that heightens both the scents of gourmet
                                    Bourbon vanilla and those refined of tuberose and jasmine. The delightful alliance
                                    reminds of tropical paradise.
                                </p>
                                <a href="#" class="button">Shop Now <i class="fa fa-arrow-right"></i></a>
                            </div>
                        </div>
...
<!--    Product area start    -->
    <div class="product_area product_area_two mb65">
        <div class="container">
            <div class="row">
                <div class="col-12">
                                    ...
                                    <figure>
                                        <div class="product_thumb">
                                            <a href="#" class="primary_img">
                                                <img src="images/products/Men/1-1.png" alt="men">
                                            </a>
                                            <a href="#" class="secondary_img">
                                                <img src="images/products/Men/1-2.png" alt="men">
                                            </a>
                            ...
                            <div class="col-lg-3">
                                <article class="single_product">
                                    <figure>
                                        <div class="product_thumb">
                                            <a href="#" class="primary_img">
                                                <img src="images/products/Men/2-1.png" alt="men">
                                            </a>
                                            <a href="#" class="secondary_img">
                                                <img src="images/products/Men/2-2.png" alt="men">
                                            </a>
                                            <div class="action_links">
                                                <ul>
                                                    <li class="add_to_cart">
                            ...
                            <div class="col-lg-3">
                                <article class="single_product">
                                    <figure>
                                        <div class="product_thumb">
                                            <a href="#" class="primary_img">
                                                <img src="images/products/Men/3-1.png" alt="men">
                                            </a>
                                            <a href="#" class="secondary_img">
                                                <img src="images/products/Men/3-2.png" alt="men">
                                            </a>
                                            <div class="action_links">
                                                <ul>
                                                    <li class="add_to_cart">
                            ...
                            <div class="col-lg-3">
                                <article class="single_product">
                                    <figure>
                                        <div class="product_thumb">
                                            <a href="#" class="primary_img">
                                                <img src="images/products/Men/4-1.png" alt="men">
                                            </a>
                                            <a href="#" class="secondary_img">
                                                <img src="images/products/Men/4-2.png" alt="men">
                                            </a>
                                            <div class="action_links">
                                                <ul>
                                                    <li class="add_to_cart">
                            ...
                            <div class="col-lg-3">
                                <article class="single_product">
                                    <figure>
                                        <div class="product_thumb">
                                            <a href="#" class="primary_img">
                                                <img src="images/products/Men/5-1.png" alt="men">
                                            </a>
                                            <a href="#" class="secondary_img">
                                                <img src="images/products/Men/5-2.png" alt="men">
                                            </a>
                                            <div class="action_links">
                                                <ul>
                                                    <li class="add_to_cart">
                            ...
                            <div class="col-lg-3">
                                <article class="single_product">
                                    <figure>
                                        <div class="product_thumb">
                                            <a href="#" class="primary_img">
                                                <img src="images/products/Men/6-1.png" alt="men">
                                            </a>
                                            <a href="#" class="secondary_img">
                                                <img src="images/products/Men/6-2.png" alt="men">
                                            </a>
                                            <div class="action_links">
                                                <ul>
                                                    <li class="add_to_cart">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4">
                    <figure class="single_banner">
                        <div class="banner_thumb">
                            <a href="#">
                                <img src="images/banner/banner1.jpg" alt="ban">
                            </a>
                ...
                <div class="col-lg-4 col-md-4">
                    <figure class="single_banner">
                        <div class="banner_thumb">
                            <a href="#">
                                <img src="images/banner/banner2.jpg" alt="ban">
                            </a>
                            <div class="banner_content">
                                <h3>Sale up to</h3>
                                <h2>70%</h2>
                ...
                <div class="col-lg-4 col-md-4">
                    <figure class="single_banner">
                        <div class="banner_thumb">
                            <a href="#">
                                <img src="images/banner/banner3.jpg" alt="ban">
                            </a>
                            <div class="banner_content">
                                <h3>Sale up to</h3>
                                <h2>30%</h2>
...
<!--                        Small product area starts          -->
                        <div class="small_product_area mb-68">
                            ...
                            <div class="small_product_container sidebar_product_colum1 owl-carousel">
                                    ...
                                    <article class="single_product">
                                        <figure>
                                            <div class="product_thumb">
                                                ...
                                                <a href="#" class="secondary_img">
                                                    <img src="images/best-product/B1-2.png" alt="">
                                                </a>
                                            </div>
                                            <figcaption class="product_content">
                                                <h4 class="product_name">
                                    ...
                                    <article class="single_product">
                                        <figure>
                                            <div class="product_thumb">
                                                ...
                                                <a href="#" class="secondary_img">
                                                    <img src="images/best-product/B2-2.png" alt="">
                                                </a>
                                            </div>
                                            <figcaption class="product_content">
                                                <h4 class="product_name">
                                                    <a href="#">Jean Paul Gautier</a>
                                                </h4>
                                                <div class="product_rating">
                                                    <ul>
                                                        <li>
                                    ...
                                    <article class="single_product">
                                        <figure>
                                            <div class="product_thumb">
                                                ...
                                                <a href="#" class="secondary_img">
                                                    <img src="images/best-product/B3-2.png" alt="">
                                                </a>
                                            </div>
                                            <figcaption class="product_content">
                                                <h4 class="product_name">
                                    ...
                                    <article class="single_product">
                                        <figure>
                                            <div class="product_thumb">
                                                ...
                                                <a href="#" class="secondary_img">
                                                    <img src="images/best-product/B6-2.png" alt="">
                                                </a>
                                            </div>
                                            <figcaption class="product_content">
                                                <h4 class="product_name">
                            ...
                            <div class="testimonial_container">
                                ...
                                <div class="testimonial_sidebar_carousel owl-carousel">
                                    <div class="single_testimonial">
                                        ...
                                        <div class="testimonial_conten">
                                            <h4><a href="#">Navnit Kamura</a></h4>
                                            <p>Lorem ipsum sit amet consectetur adingiscing  edit. Eius ommis nam
                                            eum iusto aspernatur cupidtate cupiditate, ipsam delentiti labore dolorem
                                            nostrum exercitaliomen emet goud harum blands sint atque soluta quaerat</p>
                                        </div>
                                    </div>
