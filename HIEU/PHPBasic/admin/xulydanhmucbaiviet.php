...
if (isset($_POST['themdanhmuc'])){
    ...
    $tendanhmuc = $_POST['danhmuc'];
    $sql_update = mysqli_query ($con, "update tbl_danhmuctin set tendanhmuc = '$tendanhmuc' where danhmuctin_id = '$id_capnhat_danhmuc'");
}
if (isset($_GET['xoa'])){
    $id = $_GET['xoa'];
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="xulydanhmucbaiviet.php?quanly=danhmucbaiviet">Danh mục bài viết</a>
                </li>
                <li class="nav-item">
...
<div class="container">
    <div class="row" style="padding-top: 30px">
        ...
        if ($capnhat == 'capnhat'){
            ...
            <div class="col-md-4">
                ...
                <form action="" method="post">
                    ...
                    <input type="hidden" class="form-control" name="danhmuc_id" value="<?php echo $row_capnhat['danhmuctin_id']?>">
                    </br>
        ...
        <div class="col-md-8">
            ...
            <?php
            $sql_select_category = mysqli_query ($con, "select * from tbl_danhmuctin order by danhmuctin_id desc ");
            ?>
                ...
                if ($sql_select_category){
                    while ($row_select_categor = mysqli_fetch_array ($sql_select_category)){
                        ...
                        <tr>
                            ...
                            <td><?php echo $row_select_categor['tendanhmuc']?></td>
                            <td><a href="?xoa=<?php echo $row_select_categor['danhmuctin_id']?>">Xoá</a> || <a href="?quanly=capnhat&id=<?php echo $row_select_categor['danhmuctin_id']?>">Cập nhật</a></td>
                        </tr>
                        <?php
                    }
                }
