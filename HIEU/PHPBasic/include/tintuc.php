...
<div class="container">
    ...
    <div class="welcome py-sm-5 py-4">
        ...
        <h3 class="tittle-w3l text-center mb-lg-5 mb-sm-4 mb-3">
            <span><?php echo $row_danh1['tendanhmuc']?></span></h3>
        <!-- //tittle heading -->
        <?php
            $sql_baiviet = mysqli_query ($con, "select * from tbl_danhmuctin,tbl_baiviet where tbl_danhmuctin.danhmuctin_id = tbl_baiviet.danhmuctin_id and tbl_danhmuctin.danhmuctin_id = '$id_danhmuc' order by tbl_danhmuctin.danhmuctin_id desc ");
            while ($row_baiviet = mysqli_fetch_array ($sql_baiviet)){
        ?>
        <div class="row">
            <div class="col-lg-4 welcome-right-top mt-lg-0 mt-sm-5 mt-4">
                <img src="images/<?php echo $row_baiviet['baiviet_image']?>" class="img-fluid" alt=" " style="max-width: 60%">
            </div>
