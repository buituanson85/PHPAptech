...
<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['submit'])){
        ...
        $updateProduct = $product-> update_product($_POST, $_FILES, $productId); // có hình ảnh phải có $_FILES  $_POST lấy tất cả dữ liệu
    }
?>
<div class="grid_10">
            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <table class="form">
                            ...
                            <select id="select" name="category">
                                ...
                                if ($catlist){
                                    while ($result = $catlist->fetch_assoc()){
                                        ...
                                        <option
                                            <?php
                                                if ($result['catId'] == $result_product['category']){
                                                    echo 'selected';
                                                }
                                            ?>
                            ...
                            <select id="select" name="brand">
                                ...
                                if ($brandlist){
                                    while ($result = $brandlist->fetch_assoc()){
                                        ...
                                        <option
                                            <?php  // updade
                                            if($result['brandId'] == $result_product['brand']){
                                                echo 'selected';
                                            }
                                            ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <img src="uploads/<?php echo $result_product['image']?>" style="max-width: 120px;"></br>
